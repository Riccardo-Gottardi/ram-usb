...
func GetConfig() *Config {
	return &Config{
		...
		ClientCertFile:   "../priv/client.crt", // Path to client certificate for mTLS
		ClientKeyFile:    "../priv/client.key", // Path to client private key for mTLS
		CACertFile:       "../priv/ca.crt",     // Path to CA certificate
	}
}
